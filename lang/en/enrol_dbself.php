...
/**
 * Strings for component 'enrol_dbself', language 'en'.
 *
 * @package   enrol_dbself
 * @copyright 1999 onwards Martin Dougiamas  {@link http://moodle.com}, 2015 Saylor Academy {@link http://www.saylor.org}
...
$string['pluginname'] = 'External database (Self)';
$string['pluginname_desc'] = 'You can use an external database (of nearly any kind) to control your enrolments. It is assumed your external database contains at least a field containing a course ID, and a field containing a user ID. These are compared against fields that you choose in the local course and user tables. The enrolment will be done as a self enrolment.';
...
$string['remotecoursestatusfield'] = 'Remote course status field';
$string['remotecoursestatusfield_desc'] = 'The name of the field in the remote table that shows the course status (in progress or completed).';
$string['remotecoursestatuscurrentfield'] = 'Remote course status field (In Progress)';
$string['remotecoursestatuscurrentfield_desc'] = 'The value in the remote table status field for courses that are in progress (not completed).';
$string['remotecoursestatuscompletedfield'] = 'Remote course status field (Completed)';
$string['remotecoursestatuscompletedfield_desc'] = 'The value in the remote table status field for courses that have been completed.';
$string['remotecoursegradefield'] = 'Remote course grade field';
$string['remotecoursegradefield_desc'] = 'The name of the field in the remote table that has the grade for a completed course.';
$string['remotecourseenroldatefield'] = 'Remote course enrol date field';
$string['remotecourseenroldatefield_desc'] = 'The name of the field in the remote table that has the date that the course was enroled.';
$string['remotecoursecompletiondatefield'] = 'Remote course completion date field';
$string['remotecoursecompletiondatefield_desc'] = 'The name of the field in the remote table that has the date that the course was completed.';
...
$string['remotestatusfield'] = 'Remote Status field';
$string['remotestatusfield_desc'] = 'The name of the field in the remote table that we are using to flag course status (completed or active).';
